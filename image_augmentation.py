...
num_augmentations_per_image = 9  # Number of augmented versions of each original image
all_images = []
all_labels = []
...
np.save(os.path.join(save_path, 'allam_training_400.npy'), all_images_array)
np.save(os.path.join(save_path, 'allam_targets_400.npy'), np.array(all_labels))
